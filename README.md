As a software engineer with over 3 years of experience in Full Stack Development and Growth Hacking for clients globally, I excel in driving tech innovation and creating impactful user experiences. Known for my strategic vision and leadership, I bring technical expertise and a results-oriented approach to every project.
   <b>Feel free to reach out!</b> 
   
yasminehichri01@gmail.com
<a href="mailto:yasminehichri01@gmail.com"><img src="https://img.shields.io/badge/-Email-D14836?style=flat&logo=gmail&logoColor=white" alt="Email" /></a>
<a href="https://www.linkedin.com/in/yasmine-hichri-107/" target="_blank"><img src="https://img.shields.io/badge/-LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
...
![GitHub Contribution Graph](https://github-readme-activity-graph.vercel.app/graph?username=yesminehe&theme=github-compact)
 ...
 <h2>Projects</h2>
  <div class="project">
 <h4>↪ Mentexa, a next-gen coaching mind platform</h4>
   <p><strong>Mentexa</strong> is an innovative coaching mind platform designed to empower people 
  to take care of their mental health through technology.  
  It blends artificial intelligence with human-centered design to deliver personalized 
  emotional support and self-growth tools. The platform is built around a robust AI architecture and a modern full-stack ecosystem.</p>

<ul>
  <li>Designed and implemented a <strong>5-model AI pipeline</strong>, with all models <strong>fine-tuned from scratch</strong></li>
  <li>Fine-tuned language and emotion models including <strong>Mistral</strong> and <strong>DistilRoBERTa</strong></li>
  <li>Backend developed using <strong>Flask</strong> for scalable AI services and APIs</li>
  <li>Frontend built with <strong>React.js</strong>, enhanced with smooth animations using <strong>GSAP</strong></li>
  <li><strong>PostgreSQL</strong> used for secure, structured data storage and user history tracking</li>
</ul>
  </div>
  <hr class="project-separator">
  <div class="project">
    <h4>↪ AI Gamified Traffic Sign Recognition Tool</h4>
...
<hr class="project-separator">
  <div class="project">
    <h4>↪ SEO Optimization with Machine Learning</h4>
...
<hr class="project-separator">
  <div class="project">
    <h4>↪ Smart Inventory Management Web App</h4>
...
<hr class="project-separator">
  <div class="project">
    <h4>↪ E-Learning Platform with AI-Powered Features</h4>
